...
import NavierStokesClean.AFPBridge.QuantumOps.IsabelleMarresDirac.Subset03
...
namespace NavierStokesClean.AFPBridge.QuantumGravity.QPICore
...
theorem hadamardFluctuationGate_is_gate (n : ℕ) :
  ...
  NavierStokesClean.AFPBridge.QuantumOps.IsabelleMarresDirac.Subset03.iter_tensor_H_n_is_gate n
...
def quantumGeometryState (n : ℕ) : NQubitSpace n :=
  hadamardFluctuationGate n *
    NavierStokesClean.AFPBridge.QuantumOps.IsabelleMarresDirac.Subset03.ket_zero_n n
...
theorem quantumGeometryState_is_state (n : ℕ) :
  ...
  set v := NavierStokesClean.AFPBridge.QuantumOps.IsabelleMarresDirac.Subset03.ket_zero_n n
  have hU : U ∈ Matrix.unitaryGroup (Fin (2 ^ n)) ℂ := hadamardFluctuationGate_is_gate n
  have hv : ∑ i : Fin (2 ^ n), Complex.normSq (v i 0) = 1 :=
    NavierStokesClean.AFPBridge.QuantumOps.IsabelleMarresDirac.Subset03.all_zero_state n
...
end NavierStokesClean.AFPBridge.QuantumGravity.QPICore
