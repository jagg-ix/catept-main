...
Audit layer for `CATEPT.WeylYukawaContracts` with NS-style status labels:
- `verified`
- `partiallyVerified`
- `openBridge`
...
def statusOf : ClaimId → ClaimStatus
  ...
  | .ew_sW2_plus_cW2_contract => .partiallyVerified
  | .ew_rho_tree_eq_one_contract => .partiallyVerified
  | .exists_biunitary_diag_contract => .partiallyVerified

def theoremRefOf : ClaimId → String
  | .si_from_phase_nonneg => "CATEPT.WeylYukawa.SI_from_phase_nonneg"
  | .adapter_to_foundations_complex_action =>
      "CATEPT.WeylYukawa.toFoundationsComplexAction"
  | .weyl_equation_trefoil_def => "CATEPT.WeylYukawa.weyl_equation_trefoil"
  | .dsf_phantom_information_preservation_def =>
      "CATEPT.WeylYukawa.phantomInformationPreservation"
  | .dsf_dimensional_entropy_flow_def =>
      "CATEPT.WeylYukawa.dimensionalEntropyFlow"
  | .yukawa_dirac_mass_matrix_def => "CATEPT.WeylYukawa.DiracMassMatrix"
  | .yukawa_backreaction_y_eff_def => "CATEPT.WeylYukawa.y_eff"
  | .massless_kl_weyl_correspondence =>
      "CATEPT.WeylYukawa.massless_KL_weyl_correspondence"
  | .weyl_chiral_information_flow =>
      "CATEPT.WeylYukawa.weyl_chiral_information_flow"
  | .ew_sW2_plus_cW2_contract => "CATEPT.WeylYukawa.sW2_plus_cW2_holds"
  | .ew_rho_tree_eq_one_contract => "CATEPT.WeylYukawa.rho_tree_eq_one_holds"
  | .exists_biunitary_diag_contract => "CATEPT.WeylYukawa.exists_biunitary_diag"

def noteOf : ClaimId → String
  | .si_from_phase_nonneg =>
      "Kernel theorem: SI_from_phase >= 0."
  | .adapter_to_foundations_complex_action =>
      "Executable adapter into CATEPT.ComplexAction."
  | .weyl_equation_trefoil_def =>
  ...
  | .ew_sW2_plus_cW2_contract =>
      "Textbook EW identity currently imported as a contract axiom."
  | .ew_rho_tree_eq_one_contract =>
      "Custodial rho=1 tree relation currently imported as a contract axiom."
  | .exists_biunitary_diag_contract =>
      "SVD/biunitary existence kept as contract axiom."
