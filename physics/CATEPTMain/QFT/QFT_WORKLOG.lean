...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.QFT)
License: BSD
...
Strategy:
  Direct import chain: `import CATEPTMain.IMD.IMDPrelude`
...
Validation:
  ...
  - `lake build CATEPTMain.QFT.QFTPrelude` EXIT:0
-/
...
Validation:
  - `lake build CATEPTMain.QFT.QFTPrelude` EXIT:0
  - `Theories/QFT.lean` first import is `CATEPTMain.QFT.QFTPrelude`
-/
...
Validation:
  ...
  - `lake build CATEPTMain.QFT.QFT` EXIT:0
-/
...
Checks:
  ...
  7. Build: `lake build CATEPTMain.QFT` EXIT:0
