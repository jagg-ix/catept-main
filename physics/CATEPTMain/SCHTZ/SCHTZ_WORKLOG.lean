...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.SCHTZ)
License: BSD
...
Required checks:
  1. `lake build CATEPTMain.SCHTZ.SCHTZPrelude` → EXIT:0
...
Record:
  - import CATEPTMain.SCHTZ.SCHTZPrelude added to CATEPTSelfConsistency.lean
