...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.FOU)
License: BSD
...
Validation:
  ...
  - `lake build CATEPTMain.FOU.FOUPrelude` EXIT:0
-/
...
Validation: `lake build CATEPTMain.FOU.Periodic` EXIT:0
-/
...
Validation: `lake build CATEPTMain.FOU.Lspace` EXIT:0
-/
...
Validation: `lake build CATEPTMain.FOU.Square_Integrable` EXIT:0
-/
...
Validation: `lake build CATEPTMain.FOU.Confine` EXIT:0
-/
...
Validation: `lake build CATEPTMain.FOU.Fourier_Aux2` EXIT:0
-/
...
Validation:
  ...
  - `lake build CATEPTMain.FOU.Fourier` EXIT:0
-/
...
Checks:
  ...
  6. Full build: `lake build CATEPTMain.FOU` EXIT:0
-/
...
Validation target:
  - `lake build CATEPTMain.FOU.Fourier_Aux2` EXIT:0 with reduced sorry count.
-/
...
Progress (2026-04-15):
  ...
  - Build validated: `lake build CATEPTMain.FOU.Fourier` EXIT:0.
Fix intent:
...
Validation target:
  - `lake build CATEPTMain.FOU.Fourier` EXIT:0 with theorem proved (no `sorry`).
-/
