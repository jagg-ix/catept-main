...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.QUAT)
License: BSD
...
Record:
  - import CATEPTMain.QUAT.QUATPrelude added to CATEPTSelfConsistency.lean
...
After RS-P1-QUAT is DONE, all imports of this module change from
  `CATEPTMain.QUAT.*`  →  `CATEPTMain.QUAT.*`
-/
