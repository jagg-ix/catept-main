...
namespace CATEPTMain.QuantumOps.IsabelleMarresDirac.Basics
...
-- ===== Binary_Nat =====
-- bin_rep_aux and bin_rep defined faithfully in SubsetDefs; structural lemmas are there too.
...
end CATEPTMain.QuantumOps.IsabelleMarresDirac.Basics
