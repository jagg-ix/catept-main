...
namespace CATEPTMain.HSTP.Partial_Trace

open CATEPTMain.HSTP
open CATEPTMain.CBO
open CATEPTMain.HSTP.Positive_Operators (IsHSTPPositive)
...
axiom partialTrace_density (ρ : HSTPOp)
    ...
    (hTrace : CATEPTMain.HSTP.Trace_Class.hstpTrace ρ = 1) :
    CATEPTMain.HSTP.Trace_Class.hstpTrace
...
end CATEPTMain.HSTP.Partial_Trace
