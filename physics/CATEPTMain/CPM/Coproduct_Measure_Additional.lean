...
namespace CATEPTMain.CPM.Coproduct_Measure_Additional
...
private axiom coprodMeasure_lintegral_law {I : Type} [Countable I] {alpha : I -> Type}
    ...
    (hf : Measurable f) :
    MeasureTheory.lintegral (CATEPTMain.CPM.coprodMeasure mu) f =
    tsum (fun i : I =>
...
private axiom coprodMeasure_integral_formula_law {I : Type} [Countable I] {alpha : I -> Type}
    ...
    (mu : forall i : I, MeasureTheory.Measure (alpha i))
    (f : Sigma alpha -> Real)
    (hf : MeasureTheory.Integrable f (CATEPTMain.CPM.coprodMeasure mu)) :
    MeasureTheory.integral (CATEPTMain.CPM.coprodMeasure mu) f =
    tsum (fun i : I =>
...
private axiom coprodMeasure_pushforward_law {I : Type} [Countable I] {alpha : I -> Type}
    ...
    (f : Sigma alpha -> N)
    (hf : Measurable f) :
    MeasureTheory.Measure.map f (CATEPTMain.CPM.coprodMeasure mu) =
...
private axiom coprodMeasure_prod_distrib_law {I : Type} [Countable I] {alpha : I -> Type}
    [forall i, MeasurableSpace (alpha i)]
    (mu : forall i : I, MeasureTheory.Measure (alpha i)) :
    CATEPTMain.CPM.IsSFinite (CATEPTMain.CPM.coprodMeasure mu)
...
private axiom coprodMeasure_prob_total_law {I : Type} [Fintype I] [Countable I] {alpha : I -> Type}
    [forall i, MeasurableSpace (alpha i)]
    (mu : forall i : I, MeasureTheory.Measure (alpha i)) :
    CATEPTMain.CPM.coprodMeasure mu Set.univ =
...
end CATEPTMain.CPM.Coproduct_Measure_Additional
