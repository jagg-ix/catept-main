...
namespace CATEPTMain.CPM.Coproduct_Measure
...
noncomputable def coprodMeasure {I : Type} {α : I → Type}
  ...
  @CATEPTMain.CPM.coprodMeasure I α m μ
...
theorem coproduct_measurable_iff {I : Type} {α : I → Type} {N : Type}
  ...
  simpa using
    (@CATEPTMain.CPM.coprodMeasure_measurable_iff I α N m MN μ f)
...
theorem coprodMeasure_s_finite {I : Type} {α : I → Type}
  ...
  @CATEPTMain.CPM.coprodMeasure_sfin I α m μ h

end CATEPTMain.CPM.Coproduct_Measure
