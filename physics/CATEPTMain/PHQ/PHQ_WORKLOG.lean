...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.PHQ)
License: BSD
...
Strategy:
  ...
  The namespace `CATEPTMain.PHQ` isolates all names.
...
Required checks:
  1. `lake build CATEPTMain.PHQ.PHQPrelude` → EXIT:0
...
Record:
  - import CATEPTMain.PHQ.PHQPrelude added to CATEPTSelfConsistency.lean
