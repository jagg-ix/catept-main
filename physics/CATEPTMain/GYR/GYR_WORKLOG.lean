...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.GYR)
License: BSD
...
Required checks:
  1. `lake build CATEPTMain.GYR.GYRPrelude` → EXIT:0
...
Record:
  - import CATEPTMain.GYR.GYRPrelude added to CATEPTSelfConsistency.lean
