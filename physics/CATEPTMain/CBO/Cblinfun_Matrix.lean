...
namespace CATEPTMain.CBO.Cblinfun_Matrix
...
theorem rankOne_unit_projector_bridge
  ...
  CATEPTMain.CBO.Extra_Jordan_Normal_Form.rankOne_unit_projector_bridge v hUnit
...
end CATEPTMain.CBO.Cblinfun_Matrix
