...
namespace CATEPTMain.CBO.Complex_Euclidean_Space0
...
theorem hsInner_eq_trace_adj (n : ℕ)
  ...
  theorem rankOne_unit_projector_bridge
    ...
    CATEPTMain.CBO.One_Dimensional_Spaces.rankOne_norm_projector v hUnit

end CATEPTMain.CBO.Complex_Euclidean_Space0
