...
open CATEPTMainFramework.TacticStubs  -- phase-1 tactic stubs

namespace CATEPTMain.IMD
...
noncomputable abbrev QMat := CATEPTMainFramework.AFPMat
noncomputable abbrev QVec := CATEPTMainFramework.AFPVec

-- ── Dimension accessors (from JNF Library / AFPBridgeFramework) ───────────────
noncomputable abbrev dimRow  := CATEPTMainFramework.afpDimRow
noncomputable abbrev dimCol  := CATEPTMainFramework.afpDimCol
noncomputable abbrev dimVec  := CATEPTMainFramework.afpDimVec

-- ── Matrix index operations ────────────────────────────────────────────────────
-- AFP `M $$ (i, j)` → `indexMat M i j`
noncomputable abbrev indexMat := CATEPTMainFramework.afpIndexMat
-- AFP `v $ i`       → `indexVec v i`
noncomputable abbrev indexVec := CATEPTMainFramework.afpIndexVec

-- ── Matrix arithmetic ──────────────────────────────────────────────────────────
noncomputable abbrev matMul    := CATEPTMainFramework.afpMatMul
noncomputable abbrev matAdd    := CATEPTMainFramework.afpMatAdd
...
noncomputable abbrev smulMat   := CATEPTMainFramework.afpSmulMat
noncomputable abbrev oneMat    := CATEPTMainFramework.afpOneMat
noncomputable abbrev zeroMat   := CATEPTMainFramework.afpZeroMat
noncomputable abbrev transposeMat := CATEPTMainFramework.afpTranspose
noncomputable abbrev colVec    := CATEPTMainFramework.afpColVec
noncomputable abbrev rowMat    := CATEPTMainFramework.afpRowMat
...
noncomputable abbrev dagger := CATEPTMainFramework.afpDagger

-- ── Vector arithmetic ──────────────────────────────────────────────────────────
noncomputable abbrev vecAdd    := CATEPTMainFramework.afpVecAdd
noncomputable abbrev smulVec   := CATEPTMainFramework.afpSmulVec
noncomputable abbrev scalarProd := CATEPTMainFramework.afpScalar
noncomputable abbrev innerProd := CATEPTMainFramework.afpInner      -- sesquilinear ⟨u|v⟩
noncomputable abbrev cpxVecLen := CATEPTMainFramework.afpVecNorm    -- ‖v‖
...
noncomputable abbrev ketVec := CATEPTMainFramework.afpKetVec    -- QVec → QMat
noncomputable abbrev braVec := CATEPTMainFramework.afpBraVec    -- QVec → QMat

-- ── Predicates ────────────────────────────────────────────────────────────────
abbrev unitaryMat   := CATEPTMainFramework.afpUnitary   -- M† * M = 1 ∧ M * M† = 1
abbrev hermitianMat := CATEPTMainFramework.afpHermitian -- M = M†
abbrev isSquareMat  := CATEPTMainFramework.afpIsSquare  -- dimRow = dimCol
