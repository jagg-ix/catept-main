...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.LSI)
License: BSD
...
Validation:
  ...
  - `lake build CATEPTMain.LSI.LSIPrelude` EXIT:0
-/
...
Validation:
  - `lake build CATEPTMain.LSI.Preliminaries_LSI` EXIT:0
-/
...
Validation:
  ...
  - `lake build CATEPTMain.LSI.Lebesgue_Stieltjes_Integral` EXIT:0
-/
...
Checks:
  ...
  7. Full build: `lake build CATEPTMain.LSI` EXIT:0
-/
