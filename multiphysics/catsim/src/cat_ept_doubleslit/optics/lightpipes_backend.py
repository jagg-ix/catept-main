...
@dataclass
class LightPipesEngine:
    """Optional backend wrapper for LightPipes.
    ...
    def __post_init__(self) -> None:
        if not check_available():
            raise ImportError("LightPipes is not available")
