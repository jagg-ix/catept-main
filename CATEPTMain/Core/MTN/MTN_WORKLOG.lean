...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.Core.MTN)
License: BSD
...
Record:
  - import CATEPTMain.Core.MTN.MTNPrelude added to CATEPTSelfConsistency.lean
...
After RS-P1-MTN is DONE, all imports of this module change from
  `CATEPTMain.Core.MTN.*`  →  `CATEPTMain.Core.MTN.*`
-/
