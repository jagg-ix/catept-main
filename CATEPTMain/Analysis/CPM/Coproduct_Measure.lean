...
noncomputable def coprodMeasure {I : Type} {α : I → Type}
  ...
  @CATEPTMain.Analysis.CPM.coprodMeasure I α m μ
...
theorem coproduct_measurable_iff {I : Type} {α : I → Type} {N : Type}
  ...
  simpa using
    (@CATEPTMain.Analysis.CPM.coprodMeasure_measurable_iff I α N m MN μ f)
...
theorem coprodMeasure_s_finite {I : Type} {α : I → Type}
  ...
  @CATEPTMain.Analysis.CPM.coprodMeasure_sfin I α m μ h
