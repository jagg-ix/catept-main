...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.Analysis.CPM)
License: BSD
...
Validation:
  ...
  - `lake build CATEPTMain.Analysis.CPM.CPMPrelude` EXIT:0
-/
...
Validation: `lake build CATEPTMain.Analysis.CPM.Lemmas_Coproduct_Measure` EXIT:0
-/
...
Validation:
  ...
  - `lake build CATEPTMain.Analysis.CPM.Coproduct_Measure` EXIT:0
-/
...
Validation: `lake build CATEPTMain.Analysis.CPM.Coproduct_Measure_Additional` EXIT:0
-/
...
Checks:
  ...
  7. Full build: `lake build CATEPTMain.Analysis.CPM` EXIT:0
-/
...
Validation target:
  - `lake build CATEPTMain.Analysis.CPM.Coproduct_Measure_Additional` EXIT:0
...
/-!
## RS-P1-CPM-BACKREF  Restructuring Phase 1 back-reference

This module has a `Theories/` subdirectory scheduled for removal in Phase 1.

Phase 1 move record:
  → CATEPTMain/AFPBridge/PHASE1_FLATTEN_WORKLOG.lean  (RS-P1-CPM)
...
After RS-P1-CPM is DONE, all imports of this module change from
  `CATEPTMain.Analysis.CPM.*`  →  `CATEPTMain.Analysis.CPM.*`
-/
