...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.Analysis.LSI)
License: BSD
...
Validation:
  ...
  - `lake build CATEPTMain.Analysis.LSI.LSIPrelude` EXIT:0
-/
...
Validation:
  - `lake build CATEPTMain.Analysis.LSI.Preliminaries_LSI` EXIT:0
-/
...
Validation:
  ...
  - `lake build CATEPTMain.Analysis.LSI.Lebesgue_Stieltjes_Integral` EXIT:0
-/
...
Checks:
  ...
  7. Full build: `lake build CATEPTMain.Analysis.LSI` EXIT:0
-/
...
After RS-P1-LSI is DONE, all imports of this module change from
  `CATEPTMain.Analysis.LSI.*`  →  `CATEPTMain.Analysis.LSI.*`
-/
