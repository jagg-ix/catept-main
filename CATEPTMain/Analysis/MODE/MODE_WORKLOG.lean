...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.Analysis.MODE)
License: BSD
...
Record:
  - import CATEPTMain.Analysis.MODE.MODEPrelude added to CATEPTSelfConsistency.lean
...
After RS-P1-MODE is DONE, all imports of this module change from
  `CATEPTMain.Analysis.MODE.*`  →  `CATEPTMain.Analysis.MODE.*`
-/
