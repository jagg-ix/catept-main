...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.Analysis.ODE)
License: BSD/LGPL
...
Record:
  - import CATEPTMain.Analysis.ODE.ODEPrelude added to CATEPTSelfConsistency.lean
...
After RS-P1-ODE is DONE, all imports of this module change from
  `CATEPTMain.Analysis.ODE.*`  →  `CATEPTMain.Analysis.ODE.*`
-/
