...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.Analysis.LAPL)
License: BSD
...
Record:
  - import CATEPTMain.Analysis.LAPL.LAPLPrelude added to CATEPTSelfConsistency.lean
...
After RS-P1-LAPL is DONE, all imports of this module change from
  `CATEPTMain.Analysis.LAPL.*`  →  `CATEPTMain.Analysis.LAPL.*`
-/
