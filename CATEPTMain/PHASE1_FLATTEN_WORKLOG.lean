...
Barrel change (2 lines):
  - `import CATEPTMain.OCT.Theories.Norm_Octonions`
  - `import CATEPTMain.OCT.Theories.Octonion_Algebra`
...
Validation:
  `lake build CATEPTMain.OCT` → EXIT 0
...
Barrel change (2 lines):
  - `import CATEPTMain.LSI.Theories.Lebesgue_Stieltjes_Integral`
  - `import CATEPTMain.LSI.Theories.Preliminaries_LSI`
...
Validation:
  `lake build CATEPTMain.LSI` → EXIT 0
...
Barrel change (2 lines):
  - `import CATEPTMain.MODE.Theories.Affine_ODE`
  - `import CATEPTMain.MODE.Theories.Matrix_Exp`
...
Validation:
  `lake build CATEPTMain.MODE` → EXIT 0
...
Validation:
  `lake build CATEPTMain.MTN` → EXIT 0
...
Validation:
  `lake build CATEPTMain.CPM` → EXIT 0
...
Validation:
  `lake build CATEPTMain.LAPL` → EXIT 0
...
Validation:
  `lake build CATEPTMain.MINK` → EXIT 0
...
Validation:
  `lake build CATEPTMain.ODE` → EXIT 0
...
Validation:
  `lake build CATEPTMain.PM` → EXIT 0
...
Validation:
  `lake build CATEPTMain.FOU` → EXIT 0
...
Validation:
  `lake build CATEPTMain.SM` → EXIT 0
...
Validation:
  `lake build CATEPTMain.IMD` → EXIT 0
...
Validation:
  `lake build CATEPTMain.HSTP` → EXIT 0
...
Validation:
  `lake build CATEPTMain.CBO` → EXIT 0
  `lake build CATEPTMain.HSTP` → EXIT 0  (re-check after CBO move)
...
Validation:
  `lake build CATEPTMain.NoFTL` → EXIT 0
