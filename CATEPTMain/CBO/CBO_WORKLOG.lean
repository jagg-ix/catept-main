...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.CBO)
License: BSD
...
Validation:
  ...
  - `lake build CATEPTMain.CBO.CBOPrelude` EXIT:0
-/
...
Validation:
  - `lake build CATEPTMain.CBO.Extra_Aux` EXIT:0
-/
...
Validation:
  - `lake build CATEPTMain.CBO.Complex_Vector_Spaces` EXIT:0
-/
...
Validation:
  - `lake build CATEPTMain.CBO.Complex_Inner_Product` EXIT:0
...
Validation:
  ...
  - `lake build CATEPTMain.CBO.Complex_Bounded_Linear_Function` EXIT:0
-/
...
Validation: `lake build CATEPTMain.CBO.One_Dimensional_Spaces` EXIT:0
-/
...
Validation: `lake build CATEPTMain.CBO.Complex_L2` EXIT:0
-/
...
Validation:
  ...
  - `lake build CATEPTMain.CBO.Cblinfun_Matrix` EXIT:0
-/
...
Validation: `lake build CATEPTMain.CBO.Cblinfun_Code` EXIT:0
-/
...
Checks:
  ...
  7. Full build: `lake build CATEPTMain.CBO` EXIT:0
-/
