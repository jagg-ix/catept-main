...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.SM)
License: BSD
...
Validation:
  ...
  - `lake build CATEPTMain.SM.SMPrelude` EXIT:0
-/
...
Validation: `lake build CATEPTMain.SM.Analysis_More` EXIT:0
-/
...
Validation: `lake build CATEPTMain.SM.Smooth` EXIT:0
-/
...
Validation: `lake build CATEPTMain.SM.Bump_Function` EXIT:0
-/
...
Validation:
  ...
  - `lake build CATEPTMain.SM.Chart` EXIT:0
-/
...
Validation: `lake build CATEPTMain.SM.Topological_Manifold` EXIT:0
-/
...
Validation:
  ...
  - `lake build CATEPTMain.SM.Differentiable_Manifold` EXIT:0
-/
...
Validation: `lake build CATEPTMain.SM.Partition_Of_Unity` EXIT:0
-/
...
Validation:
  ...
  - `lake build CATEPTMain.SM.Tangent_Space` EXIT:0
-/
...
Validation: `lake build CATEPTMain.SM.Concrete_Manifolds` EXIT:0
-/
...
Checks:
  ...
  7. Full build: `lake build CATEPTMain.SM` EXIT:0
-/
