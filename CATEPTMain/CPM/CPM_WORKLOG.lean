...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.CPM)
License: BSD
...
Validation:
  ...
  - `lake build CATEPTMain.CPM.CPMPrelude` EXIT:0
-/
...
Validation: `lake build CATEPTMain.CPM.Lemmas_Coproduct_Measure` EXIT:0
-/
...
Validation:
  ...
  - `lake build CATEPTMain.CPM.Coproduct_Measure` EXIT:0
-/
...
Validation: `lake build CATEPTMain.CPM.Coproduct_Measure_Additional` EXIT:0
-/
...
Checks:
  ...
  7. Full build: `lake build CATEPTMain.CPM` EXIT:0
-/
...
Validation target:
  - `lake build CATEPTMain.CPM.Coproduct_Measure_Additional` EXIT:0
