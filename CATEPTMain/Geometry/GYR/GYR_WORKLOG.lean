...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.Geometry.GYR)
License: BSD
...
Required checks:
  1. `lake build CATEPTMain.Geometry.GYR.GYRPrelude` → EXIT:0
...
Record:
  - import CATEPTMain.Geometry.GYR.GYRPrelude added to CATEPTSelfConsistency.lean
