...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.Geometry.MINK)
License: BSD
...
Record:
  - import CATEPTMain.Geometry.MINK.MINKPrelude added to CATEPTSelfConsistency.lean
...
After RS-P1-MINK is DONE, all imports of this module change from
  `CATEPTMain.Geometry.MINK.*`  →  `CATEPTMain.Geometry.MINK.*`
-/
