import CATEPTPluginDomainGeometry.NoFTL.AffineConeLemma

/-!
# AffineConeLemma — re-export shim
Authoritative source: `CATEPTPluginDomainGeometry.NoFTL.AffineConeLemma` in sibling
