import CATEPTPluginDomainGeometry.NoFTL.CauchySchwarz

/-!
# CauchySchwarz — re-export shim
Authoritative source: `CATEPTPluginDomainGeometry.NoFTL.CauchySchwarz` in sibling
