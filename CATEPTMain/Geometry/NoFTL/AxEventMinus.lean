import CATEPTPluginDomainGeometry.NoFTL.AxEventMinus

/-!
# AxEventMinus — re-export shim
Authoritative source: `CATEPTPluginDomainGeometry.NoFTL.AxEventMinus` in sibling
