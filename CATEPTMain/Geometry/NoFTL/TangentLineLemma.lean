import CATEPTPluginDomainGeometry.NoFTL.TangentLineLemma

/-!
# TangentLineLemma — re-export shim
Authoritative source: `CATEPTPluginDomainGeometry.NoFTL.TangentLineLemma` in sibling
