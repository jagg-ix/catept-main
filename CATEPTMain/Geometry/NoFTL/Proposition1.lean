import CATEPTPluginDomainGeometry.NoFTL.Proposition1

/-!
# Proposition1 — re-export shim
Authoritative source: `CATEPTPluginDomainGeometry.NoFTL.Proposition1` in sibling
