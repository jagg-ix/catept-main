import CATEPTPluginDomainGeometry.NoFTL.ObserverConeLemma

/-!
# ObserverConeLemma — re-export shim
Authoritative source: `CATEPTPluginDomainGeometry.NoFTL.ObserverConeLemma` in sibling
