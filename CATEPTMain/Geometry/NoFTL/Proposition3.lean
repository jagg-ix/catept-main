import CATEPTPluginDomainGeometry.NoFTL.Proposition3

/-!
# Proposition3 — re-export shim
Authoritative source: `CATEPTPluginDomainGeometry.NoFTL.Proposition3` in sibling
