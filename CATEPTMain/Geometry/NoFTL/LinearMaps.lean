import CATEPTPluginDomainGeometry.NoFTL.LinearMaps

/-!
# LinearMaps — re-export shim
Authoritative source: `CATEPTPluginDomainGeometry.NoFTL.LinearMaps` in sibling
