import CATEPTPluginDomainGeometry.NoFTL.NoFTLPrelude

/-!
# NoFTLPrelude — re-export shim
Authoritative source: `CATEPTPluginDomainGeometry.NoFTL.NoFTLPrelude` in sibling
