import CATEPTPluginDomainGeometry.NoFTL.Cardinalities

/-!
# Cardinalities — re-export shim
Authoritative source: `CATEPTPluginDomainGeometry.NoFTL.Cardinalities` in sibling
