import CATEPTPluginDomainGeometry.NoFTL.Proposition2

/-!
# Proposition2 — re-export shim
Authoritative source: `CATEPTPluginDomainGeometry.NoFTL.Proposition2` in sibling
