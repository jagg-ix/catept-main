import CATEPTPluginDomainGeometry.NoFTL.AxLightMinus

/-!
# AxLightMinus — re-export shim
Authoritative source: `CATEPTPluginDomainGeometry.NoFTL.AxLightMinus` in sibling
