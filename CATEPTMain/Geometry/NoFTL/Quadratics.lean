import CATEPTPluginDomainGeometry.NoFTL.Quadratics

/-!
# Quadratics — re-export shim
Authoritative source: `CATEPTPluginDomainGeometry.NoFTL.Quadratics` in sibling
