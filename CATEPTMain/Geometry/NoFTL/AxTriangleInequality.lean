import CATEPTPluginDomainGeometry.NoFTL.AxTriangleInequality

/-!
# AxTriangleInequality — re-export shim
Authoritative source: `CATEPTPluginDomainGeometry.NoFTL.AxTriangleInequality` in sibling
