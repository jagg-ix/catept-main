import CATEPTPluginDomainGeometry.NoFTL.AxSelfMinus

/-!
# AxSelfMinus — re-export shim
Authoritative source: `CATEPTPluginDomainGeometry.NoFTL.AxSelfMinus` in sibling
