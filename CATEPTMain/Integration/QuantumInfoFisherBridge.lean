...
theorem relative_modularWeight_shift_invariant
    {n : ℕ} (ρ ρ₀ : CATEPTMain.Quantum.QUANTUM.DensityMatrix n)
    (K : CATEPTMain.Quantum.QUANTUM.QSquare n) (c : ℂ) :
    CATEPTMain.Quantum.QUANTUM.relativeModularWeight ρ ρ₀
      (K + c • (1 : CATEPTMain.Quantum.QUANTUM.QSquare n)) =
...
theorem liouville_doubleSpace_mapping_for
    (n : ℕ) (Heff : ℝ → CATEPTMain.Quantum.QUANTUM.QSquare (n * n)) :
