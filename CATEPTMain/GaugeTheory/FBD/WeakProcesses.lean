...
namespace CATEPTMain.GaugeTheory.FBD
...
theorem projLeft_idempotent : projLeft * projLeft = projLeft := by
  have h : projLeft = CATEPTMain.GaugeTheory.FEYNCALC.chiralP7 := by
    simp only [projLeft, CATEPTMain.GaugeTheory.FEYNCALC.chiralP7,
               show ∀ (a b : FCEnd), addEnd a b = a + b from fun _ _ => rfl]
    congr 1; rw [← negEnd_eq_smulNeg]
  rw [h]; exact CATEPTMain.GaugeTheory.FEYNCALC.chiralP7_idempotent
...
theorem projRight_idempotent : projRight * projRight = projRight := by
  have h : projRight = CATEPTMain.GaugeTheory.FEYNCALC.chiralP6 := by
    simp only [projRight, CATEPTMain.GaugeTheory.FEYNCALC.chiralP6,
               show ∀ (a b : FCEnd), addEnd a b = a + b from fun _ _ => rfl]
  rw [h]; exact CATEPTMain.GaugeTheory.FEYNCALC.chiralP6_idempotent
...
theorem projLeft_projRight_zero : projLeft * projRight = zeroEnd := by
  have hl : projLeft = CATEPTMain.GaugeTheory.FEYNCALC.chiralP7 := by
    simp only [projLeft, CATEPTMain.GaugeTheory.FEYNCALC.chiralP7,
               show ∀ (a b : FCEnd), addEnd a b = a + b from fun _ _ => rfl]
    congr 1; rw [← negEnd_eq_smulNeg]
  have hr : projRight = CATEPTMain.GaugeTheory.FEYNCALC.chiralP6 := by
    simp only [projRight, CATEPTMain.GaugeTheory.FEYNCALC.chiralP6,
               show ∀ (a b : FCEnd), addEnd a b = a + b from fun _ _ => rfl]
  rw [hl, hr]; exact CATEPTMain.GaugeTheory.FEYNCALC.chiralP7_chiralP6_zero
...
end CATEPTMain.GaugeTheory.FBD
