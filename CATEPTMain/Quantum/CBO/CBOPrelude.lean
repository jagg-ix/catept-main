...
noncomputable axiom cblinfunToMatrix :
    CBOOp → CATEPTMain.Core.Framework.AFPMat
noncomputable axiom matrixToCblinfun :
    CATEPTMain.Core.Framework.AFPMat → CBOOp
axiom cblinfunToMatrix_roundtrip (T : CBOOp) :
    matrixToCblinfun (cblinfunToMatrix T) = T
axiom matrixToCblinfun_adjoint (M : CATEPTMain.Core.Framework.AFPMat) :
    cboAdj (matrixToCblinfun M) =
    matrixToCblinfun (CATEPTMain.Core.Framework.afpDagger M)
