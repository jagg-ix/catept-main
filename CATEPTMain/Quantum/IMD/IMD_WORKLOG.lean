...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.Quantum.IMD)
License: BSD
...
Generalized framework: rather than writing IMDPrelude.lean from scratch,
  use the universal AFP Bridge Framework:
    ...
    open CATEPTMain.Core.Framework.TacticStubs  -- (phase-1 only)
...
Validation:
  ...
  - `lake build CATEPTMain.Quantum.IMD.IMDPrelude` EXIT:0
...
Fix target (translator):
  ...
  Validation: `lake build CATEPTMain.Quantum.IMD.IMDPrelude` EXIT:0 before
  any theory file is generated.
Validation:
  - IMDPrelude.lean: no unknown identifier on first build
  - All 13 theory files import `CATEPTMain.Quantum.IMD.IMDPrelude` not any NoFTL prelude
  - `lake build CATEPTMain.Quantum.IMD.IMDPrelude` EXIT:0
...
Fix target (translator):
  Standard header for all IMD theory files:
    ...
    namespace CATEPTMain.Quantum.IMD.Theories
    ...
    end CATEPTMain.Quantum.IMD.Theories
...
Validation:
  - `lake build CATEPTMain.Quantum.IMD.Basics` EXIT:0
...
Validation:
  - `lake build CATEPTMain.Quantum.IMD.Binary_Nat` EXIT:0
...
Validation:
  - `lake build CATEPTMain.Quantum.IMD.Complex_Vectors` EXIT:0
...
Validation:
  ...
  - `lake build CATEPTMain.Quantum.IMD.Quantum` EXIT:0
...
Validation:
  ...
  - `lake build CATEPTMain.Quantum.IMD.Tensor` EXIT:0
...
Validation:
  - `lake build CATEPTMain.Quantum.IMD.More_Tensor` EXIT:0
...
Validation:
  - `lake build CATEPTMain.Quantum.IMD.Measurement` EXIT:0
...
Validation:
  - `lake build CATEPTMain.Quantum.IMD.Entanglement` EXIT:0
...
Validation:
  - `lake build CATEPTMain.Quantum.IMD.Quantum_Teleportation` EXIT:0
...
Validation:
  - `lake build CATEPTMain.Quantum.IMD.Deutsch` EXIT:0
...
Validation:
  - `lake build CATEPTMain.Quantum.IMD.Deutsch_Jozsa` EXIT:0
...
Validation:
  ...
  - `lake build CATEPTMain.Quantum.IMD.No_Cloning` EXIT:0
...
Validation:
  - `lake build CATEPTMain.Quantum.IMD.Quantum_Prisoners_Dilemma` EXIT:0
...
Content plan:
  ...
  structure DiracGateBridgeContract where
    n      : ℕ
    gate   : CATEPTMain.Quantum.IMD.Gate n
...
Checks (NoFTL-derived, adapted for IMD):
  ...
  8. Prelude builds before theory files:
     lake build CATEPTMain.Quantum.IMD.IMDPrelude → must EXIT:0 FIRST
  ...
  10. All 13 theory files build:
     for thy in Basics Binary_Nat Complex_Vectors Quantum Tensor More_Tensor
       ...
       lake build CATEPTMain.Quantum.IMD.$thy → must EXIT:0
     done
...
After RS-P1-IMD is DONE, all imports of this module change from
  `CATEPTMain.Quantum.IMD.*`  →  `CATEPTMain.Quantum.IMD.*`
-/
