...
private axiom sot_implies_wot_law (Tseq : ℕ → HSTPOp) (T : HSTPOp)
    (hSOT : CATEPTMain.Quantum.HSTP.Strong_Operator_Topology.HSTPStrongConv Tseq T) :
    HSTPWeakConv Tseq T
...
def IsHSTPUnitary (U : HSTPOp) : Prop :=
  CATEPTMain.Quantum.HSTP.Strong_Operator_Topology.hstpOpComp (hstpOpAdj U) U = U ∧
  CATEPTMain.Quantum.HSTP.Strong_Operator_Topology.hstpOpComp U (hstpOpAdj U) = U
