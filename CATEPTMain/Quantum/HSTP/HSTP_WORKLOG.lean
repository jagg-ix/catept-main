...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.Quantum.HSTP)
License: BSD
...
Strategy:
  - `import CATEPTMain.Quantum.CBO.CBOPrelude` (must be stable first)
  - ODE bridge: axiom stubs for semigroup generator; skip Stone's theorem in phase-1
  - With_Type: empty stub module `CATEPTMain.Quantum.HSTP.WithTypeStub`
...
Validation:
  ...
  - `lake build CATEPTMain.Quantum.HSTP.HSTPPrelude` EXIT:0
-/
...
Validation:
  - `lake build CATEPTMain.Quantum.HSTP.HSTPPrelude` EXIT:0
  - All HSTP theory files begin with `import CATEPTMain.Quantum.HSTP.HSTPPrelude`
-/
...
Validation: `lake build CATEPTMain.Quantum.HSTP.Misc_Tensor_Product` EXIT:0
-/
...
Validation:
  - `lake build CATEPTMain.Quantum.HSTP.Operator_Topologies` EXIT:0
-/
...
Validation: `lake build CATEPTMain.Quantum.HSTP.Positive_Operators` EXIT:0
-/
...
Validation: `lake build CATEPTMain.Quantum.HSTP.HS2Ell2` EXIT:0
-/
...
Validation:
  ...
  - `lake build CATEPTMain.Quantum.HSTP.Compact_Operators` EXIT:0
-/
...
Validation: `lake build CATEPTMain.Quantum.HSTP.Trace_Class` EXIT:0
-/
...
Validation:
  ...
  - `lake build CATEPTMain.Quantum.HSTP.Hilbert_Space_Tensor_Product` EXIT:0
-/
...
Validation: `lake build CATEPTMain.Quantum.HSTP.Partial_Trace` EXIT:0
-/
...
Validation: `lake build CATEPTMain.Quantum.HSTP.Von_Neumann_Algebras` EXIT:0
-/
...
Validation: `lake build CATEPTMain.Quantum.HSTP.Tensor_Product_Code` EXIT:0
-/
...
Content plan:
  ...
  import CATEPTMain.Quantum.CBO.Theories.Cblinfun_Matrix
...
Checks:
  ...
  7. Full build: `lake build CATEPTMain.Quantum.HSTP` EXIT:0
-/
...
After RS-P1-HSTP is DONE, all imports of this module change from
  `CATEPTMain.Quantum.HSTP.*`  →  `CATEPTMain.Quantum.HSTP.*`
-/
