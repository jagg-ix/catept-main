...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.CATEPT.QFT)
License: BSD
...
Strategy:
  Direct import chain: `import CATEPTMain.Quantum.IMD.IMDPrelude`
...
Validation:
  ...
  - `lake build CATEPTMain.CATEPT.QFT.QFTPrelude` EXIT:0
-/
...
Validation:
  - `lake build CATEPTMain.CATEPT.QFT.QFTPrelude` EXIT:0
  - `Theories/QFT.lean` first import is `CATEPTMain.CATEPT.QFT.QFTPrelude`
-/
...
Validation:
  ...
  - `lake build CATEPTMain.CATEPT.QFT.QFT` EXIT:0
-/
...
Checks:
  ...
  7. Build: `lake build CATEPTMain.CATEPT.QFT` EXIT:0
...
After RS-P1-QFT is DONE, all imports of this module change from
  `CATEPTMain.CATEPT.QFT.*`  →  `CATEPTMain.CATEPT.QFT.*`
-/
