...
```
import CATEPTMain.CATEPT.CATEPT.Examples.Ex01_ComplexAction    -- S_I ≥ 0 (theorem!)
import CATEPTMain.CATEPT.CATEPT.Examples.Ex02_EntropicTime     -- τ_ent = S_I/ℏ
import CATEPTMain.CATEPT.CATEPT.Examples.Ex03_FeynmanKacDamping -- ‖w‖ ≤ 1
import CATEPTMain.CATEPT.CATEPT.Examples.Ex04_TsirelsonFromEntropy
import CATEPTMain.CATEPT.CATEPT.Examples.Ex05_PauliNoGoBypassed
import CATEPTMain.CATEPT.CATEPT.Examples.Ex06_ModularFlowTripleClock
import CATEPTMain.CATEPT.CATEPT.Examples.Ex07_WheelerDeWittConstraint
import CATEPTMain.CATEPT.CATEPT.Examples.Ex08_BekensteinHawking
import CATEPTMain.CATEPT.CATEPT.Examples.Ex09_LandauerBound
import CATEPTMain.CATEPT.CATEPT.Examples.Ex10_UVConvergence
import CATEPTMain.CATEPT.CATEPT.Examples.Ex11_MuonGMinus2
import CATEPTMain.CATEPT.CATEPT.Examples.Ex12_TrefoilTopology
import CATEPTMain.CATEPT.CATEPT.Examples.Ex13_FrameworkUnification
import CATEPTMain.CATEPT.CATEPT.Examples.Ex14_PredictionsVsData
import CATEPTMain.CATEPT.CATEPT.Examples.Ex15_AccuracyCheck
import CATEPTMain.CATEPT.CATEPT.Examples.Ex16_HigherOrderAccuracy
import CATEPTMain.CATEPT.CATEPT.Examples.Ex17_DecoherencePredictions
import CATEPTMain.CATEPT.CATEPT.Examples.Ex18_LeptonHierarchy
import CATEPTMain.CATEPT.CATEPT.Examples.Ex19_ClassicalGravity
import CATEPTMain.CATEPT.CATEPT.Examples.Ex20_CatsimIntegration
import CATEPTMain.CATEPT.CATEPT.Examples.Ex21_ComplexEFEAndCoupler
```
