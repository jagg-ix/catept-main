...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.PDC)
License: BSD
...
Required checks:
  1. `lake build CATEPTMain.PDC.PDCPrelude` → EXIT:0
...
Record:
  - import CATEPTMain.PDC.PDCPrelude added to CATEPTSelfConsistency.lean
