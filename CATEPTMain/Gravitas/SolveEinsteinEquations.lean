...
/-!
# SolveEinsteinEquations — re-export shim
Authoritative source: `CATEPTGravitasPort.SolveEinsteinEquations` in sibling repo
[`jagg-ix/catept-gravitas-port`](https://github.com/jagg-ix/catept-gravitas-port).

Gravitas declares bare top-level namespaces (e.g. `namespace SolveEinsteinEquations`) per
