...
/-!
# SolveADMEquations — re-export shim
Authoritative source: `CATEPTGravitasPort.SolveADMEquations` in sibling repo
[`jagg-ix/catept-gravitas-port`](https://github.com/jagg-ix/catept-gravitas-port).

Gravitas declares bare top-level namespaces (e.g. `namespace SolveADMEquations`) per
