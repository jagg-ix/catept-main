...
/-!
# AngularMomentumTensor — re-export shim
Authoritative source: `CATEPTGravitasPort.AngularMomentumTensor` in sibling repo
[`jagg-ix/catept-gravitas-port`](https://github.com/jagg-ix/catept-gravitas-port).

Gravitas declares bare top-level namespaces (e.g. `namespace AngularMomentumTensor`) per
