...
/-!
# ChristoffelSymbols — re-export shim
Authoritative source: `CATEPTGravitasPort.ChristoffelSymbols` in sibling repo
[`jagg-ix/catept-gravitas-port`](https://github.com/jagg-ix/catept-gravitas-port).

Gravitas declares bare top-level namespaces (e.g. `namespace ChristoffelSymbols`) per
