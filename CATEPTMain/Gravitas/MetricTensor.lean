...
/-!
# MetricTensor — re-export shim
Authoritative source: `CATEPTGravitasPort.MetricTensor` in sibling repo
[`jagg-ix/catept-gravitas-port`](https://github.com/jagg-ix/catept-gravitas-port).

Gravitas declares bare top-level namespaces (e.g. `namespace MetricTensor`) per
