...
/-!
# DiscreteHypersurfaceGeodesic — re-export shim
Authoritative source: `CATEPTGravitasPort.DiscreteHypersurfaceGeodesic` in sibling repo
[`jagg-ix/catept-gravitas-port`](https://github.com/jagg-ix/catept-gravitas-port).

Gravitas declares bare top-level namespaces (e.g. `namespace DiscreteHypersurfaceGeodesic`) per
