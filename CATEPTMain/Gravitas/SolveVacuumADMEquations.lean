...
/-!
# SolveVacuumADMEquations — re-export shim
Authoritative source: `CATEPTGravitasPort.SolveVacuumADMEquations` in sibling repo
[`jagg-ix/catept-gravitas-port`](https://github.com/jagg-ix/catept-gravitas-port).

Gravitas declares bare top-level namespaces (e.g. `namespace SolveVacuumADMEquations`) per
