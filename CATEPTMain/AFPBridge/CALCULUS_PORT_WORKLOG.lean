...
### Namespace adaptation
  ...
  Target uses `namespace CATEPTMain.AFPBridge.CALCULUS`.
...
2. Replace header:
   - `namespace Proofs` → `namespace CATEPTMain.AFPBridge.CALCULUS`
3. Add import:
   - `import CATEPTMain.AFPBridge.CALCULUS.CALCPrelude`
   (or inline the Vec/Mat defs if CALCPrelude hasn't landed yet)
4. `lake build CATEPTMain.AFPBridge.CALCULUS.Differentiation` → EXIT 0.
...
### Validation
  ...
  `lake build CATEPTMain.AFPBridge.CALCULUS.Differentiation` → EXIT 0.
...
### Validation
  ...
  - import rewrite to `CATEPTMain.AFPBridge.CALCULUS.Differentiation`
  - namespace rewrite `Proofs` → `CATEPTMain.AFPBridge.CALCULUS`
  - `set_option autoImplicit true` for local compatibility
  `lake build CATEPTMain.AFPBridge.CALCULUS.Normalization` → EXIT 0.
...
### Validation
  ...
  - namespace rewrite `Proofs` → `CATEPTMain.AFPBridge.CALCULUS`
  - `set_option autoImplicit true` for local compatibility
  `lake build CATEPTMain.AFPBridge.CALCULUS.Attention` → EXIT 0.
...
retired by importing `CATEPTMain.AFPBridge.CALCULUS.Differentiation`.
...
### Procedure per stub
  1. Add `import CATEPTMain.AFPBridge.CALCULUS.Differentiation` to the file.
...
### Validation
  ...
  `0 < hbar`, `0 ≤ S_I`, `0 ≤ S_I'`.
  `lake build CATEPTMain.AFPBridge.CATEPT.ModularFlowBridge` → EXIT 0.
  `lake build CATEPTMain.AFPBridge` → EXIT 0.
