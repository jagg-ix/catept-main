...
namespace CATEPTMain.AFPBridge.CBO.Complex_Bounded_Linear_Function

open CATEPTMain.AFPBridge.CBO
open CATEPTMain.AFPBridge.CBO.Complex_Bounded_Linear_Function0
...
theorem rankOne_unit_projector_bridge
    (v : CBOVec)
    (hUnit : CATEPTMain.AFPBridge.CBO.Extra_Pretty_Code_Examples.cboVecNorm v = 1) :
    IsCBOProjector (CATEPTMain.AFPBridge.CBO.Extra_Pretty_Code_Examples.rankOneOp v v) :=
  CATEPTMain.AFPBridge.CBO.Complex_Bounded_Linear_Function0.rankOne_unit_projector_bridge v hUnit
...
end CATEPTMain.AFPBridge.CBO.Complex_Bounded_Linear_Function
