...
namespace CATEPTMain.AFPBridge.CBO.Cblinfun_Code_Examples

open CATEPTMain.AFPBridge.CBO
open CATEPTMain.AFPBridge.CBO.Cblinfun_Matrix (opToMatrix)
...
end CATEPTMain.AFPBridge.CBO.Cblinfun_Code_Examples
