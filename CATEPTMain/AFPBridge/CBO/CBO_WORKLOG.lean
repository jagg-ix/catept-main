...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.AFPBridge.CBO)
License: BSD
...
Validation:
  ...
  - `lake build CATEPTMain.AFPBridge.CBO.CBOPrelude` EXIT:0
-/
...
Checks:
  ...
  7. Full build: `lake build CATEPTMain.AFPBridge.CBO` EXIT:0
-/
