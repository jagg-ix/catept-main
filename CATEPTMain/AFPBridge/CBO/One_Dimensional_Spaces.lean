...
namespace CATEPTMain.AFPBridge.CBO.One_Dimensional_Spaces

open CATEPTMain.AFPBridge.CBO
open CATEPTMain.AFPBridge.CBO.Extra_Pretty_Code_Examples
...
end CATEPTMain.AFPBridge.CBO.One_Dimensional_Spaces
