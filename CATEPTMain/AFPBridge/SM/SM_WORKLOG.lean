...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.AFPBridge.SM)
License: BSD
...
Validation:
  ...
  - `lake build CATEPTMain.AFPBridge.SM.SMPrelude` EXIT:0
-/
...
Required prelude content (skeleton):
  ...
  namespace CATEPTMain.AFPBridge.SM
...
Checks:
  ...
  7. Full build: `lake build CATEPTMain.AFPBridge.SM` EXIT:0
-/
