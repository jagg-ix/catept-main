...
namespace CATEPTMain.AFPBridge.HSTP.Weak_Operator_Topology
...
private axiom sot_implies_wot_law (Tseq : ℕ → HSTPOp) (T : HSTPOp)
    (hSOT : CATEPTMain.AFPBridge.HSTP.Strong_Operator_Topology.HSTPStrongConv Tseq T) :
    HSTPWeakConv Tseq T
...
def IsHSTPUnitary (U : HSTPOp) : Prop :=
  CATEPTMain.AFPBridge.HSTP.Strong_Operator_Topology.hstpOpComp (hstpOpAdj U) U = U ∧
  CATEPTMain.AFPBridge.HSTP.Strong_Operator_Topology.hstpOpComp U (hstpOpAdj U) = U
...
end CATEPTMain.AFPBridge.HSTP.Weak_Operator_Topology
