...
namespace CATEPTMain.AFPBridge.HSTP.Spectral_Theorem
...
def IsHSTPSpectralMeasure (E : Set ℝ → HSTPOp)
  ...
  (∀ B : Set ℝ,  -- B ranges over Borel sets (MeasurableSet requirement deferred to phase-2)
    CATEPTMain.AFPBridge.HSTP.Strong_Operator_Topology.hstpOpComp (E B) (E B) = E B) ∧
...
end CATEPTMain.AFPBridge.HSTP.Spectral_Theorem
