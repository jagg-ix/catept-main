...
namespace CATEPTMain.AFPBridge.HSTP.Partial_Trace

open CATEPTMain.AFPBridge.HSTP
open CATEPTMain.AFPBridge.CBO
open CATEPTMain.AFPBridge.HSTP.Positive_Operators (IsHSTPPositive)
...
axiom partialTrace_density (ρ : HSTPOp)
    ...
    (hTrace : CATEPTMain.AFPBridge.HSTP.Trace_Class.hstpTrace ρ = 1) :
    CATEPTMain.AFPBridge.HSTP.Trace_Class.hstpTrace
...
end CATEPTMain.AFPBridge.HSTP.Partial_Trace
