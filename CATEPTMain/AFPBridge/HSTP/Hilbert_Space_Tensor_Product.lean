...
namespace CATEPTMain.AFPBridge.HSTP.Hilbert_Space_Tensor_Product
...
private axiom hstpOpTensor_unitary_law (U V : CBOOp)
    ...
    CATEPTMain.AFPBridge.HSTP.Weak_Operator_Topology.IsHSTPUnitary (hstpOpTensor U V)
...
end CATEPTMain.AFPBridge.HSTP.Hilbert_Space_Tensor_Product
