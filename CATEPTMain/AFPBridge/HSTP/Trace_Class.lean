...
namespace CATEPTMain.AFPBridge.HSTP.Trace_Class
...
private axiom traceClass_compact_law (T : HSTPOp) (hTC : IsTraceClass T) :
    CATEPTMain.AFPBridge.HSTP.Eigenvalues.IsHSTPCompact T

theorem traceClass_compact (T : HSTPOp) (hTC : IsTraceClass T) :
    CATEPTMain.AFPBridge.HSTP.Eigenvalues.IsHSTPCompact T := traceClass_compact_law T hTC

end CATEPTMain.AFPBridge.HSTP.Trace_Class
