...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.AFPBridge.FOU)
License: BSD
...
Validation:
  ...
  - `lake build CATEPTMain.AFPBridge.FOU.FOUPrelude` EXIT:0
-/
...
Checks:
  ...
  6. Full build: `lake build CATEPTMain.AFPBridge.FOU` EXIT:0
-/
