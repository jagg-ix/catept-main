...
Physical foundations live in `CATEPTMain.AFPBridge.CATEPT.CATEPTPlanckBridge`.
Abstract CATEPT structure: `CATEPTMain.AFPBridge.CATEPT.CATEPTPrelude`.
...
namespace CATEPTMain.AFPBridge.CATEPT.PlanckModeBridge
...
end CATEPTMain.AFPBridge.CATEPT.PlanckModeBridge
