...
open CATEPTMain.AFPBridgeFramework.TacticStubs  -- phase-1 tactic stubs

namespace CATEPTMain.AFPBridge.IMD
...
noncomputable abbrev QMat := CATEPTMain.AFPBridgeFramework.AFPMat
noncomputable abbrev QVec := CATEPTMain.AFPBridgeFramework.AFPVec

-- ── Dimension accessors (from JNF Library / AFPBridgeFramework) ───────────────
noncomputable abbrev dimRow  := CATEPTMain.AFPBridgeFramework.afpDimRow
noncomputable abbrev dimCol  := CATEPTMain.AFPBridgeFramework.afpDimCol
noncomputable abbrev dimVec  := CATEPTMain.AFPBridgeFramework.afpDimVec

-- ── Matrix index operations ────────────────────────────────────────────────────
-- AFP `M $$ (i, j)` → `indexMat M i j`
noncomputable abbrev indexMat := CATEPTMain.AFPBridgeFramework.afpIndexMat
-- AFP `v $ i`       → `indexVec v i`
noncomputable abbrev indexVec := CATEPTMain.AFPBridgeFramework.afpIndexVec
...
noncomputable abbrev transposeMat := CATEPTMain.AFPBridgeFramework.afpTranspose
noncomputable abbrev colVec    := CATEPTMain.AFPBridgeFramework.afpColVec
noncomputable abbrev rowMat    := CATEPTMain.AFPBridgeFramework.afpRowMat
...
noncomputable abbrev dagger := CATEPTMain.AFPBridgeFramework.afpDagger

-- ── Vector arithmetic ──────────────────────────────────────────────────────────
noncomputable abbrev vecAdd    := CATEPTMain.AFPBridgeFramework.afpVecAdd
noncomputable abbrev smulVec   := CATEPTMain.AFPBridgeFramework.afpSmulVec
...
noncomputable abbrev ketVec := CATEPTMain.AFPBridgeFramework.afpKetVec    -- QVec → QMat
noncomputable abbrev braVec := CATEPTMain.AFPBridgeFramework.afpBraVec    -- QVec → QMat

-- ── Predicates ────────────────────────────────────────────────────────────────
abbrev unitaryMat   := CATEPTMain.AFPBridgeFramework.afpUnitary   -- M† * M = 1 ∧ M * M† = 1
abbrev hermitianMat := CATEPTMain.AFPBridgeFramework.afpHermitian -- M = M†
abbrev isSquareMat  := CATEPTMain.AFPBridgeFramework.afpIsSquare  -- dimRow = dimCol
