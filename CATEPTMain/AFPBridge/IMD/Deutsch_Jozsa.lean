...
namespace CATEPTMain.AFPBridge.IMD.Deutsch_Jozsa
...
noncomputable def H_n (n : ℕ) : QMat :=
  CATEPTMain.AFPBridge.IMD.More_Tensor.tensorPow H_gate n

theorem H_n_dimRow (n : ℕ) : dimRow (H_n n) = 2^n :=
  CATEPTMain.AFPBridge.IMD.More_Tensor.tensorPow_dimRow H_gate n H_gate_dimRow

theorem H_n_dimCol (n : ℕ) : dimCol (H_n n) = 2^n :=
  CATEPTMain.AFPBridge.IMD.More_Tensor.tensorPow_dimCol H_gate n H_gate_dimCol
...
end CATEPTMain.AFPBridge.IMD.Deutsch_Jozsa
