...
namespace CATEPTMain.AFPBridge.CPM.Coproduct_Measure_Additional
...
private axiom coprodMeasure_lintegral_law {I : Type} [Countable I] {alpha : I -> Type}
    ...
    (hf : Measurable f) :
    MeasureTheory.lintegral (CATEPTMain.AFPBridge.CPM.coprodMeasure mu) f =
    tsum (fun i : I =>
...
private axiom coprodMeasure_integral_formula_law {I : Type} [Countable I] {alpha : I -> Type}
    ...
    (mu : forall i : I, MeasureTheory.Measure (alpha i))
    (f : Sigma alpha -> Real)
    (hf : MeasureTheory.Integrable f (CATEPTMain.AFPBridge.CPM.coprodMeasure mu)) :
    MeasureTheory.integral (CATEPTMain.AFPBridge.CPM.coprodMeasure mu) f =
    tsum (fun i : I =>
...
private axiom coprodMeasure_pushforward_law {I : Type} [Countable I] {alpha : I -> Type}
    ...
    (f : Sigma alpha -> N)
    (hf : Measurable f) :
    MeasureTheory.Measure.map f (CATEPTMain.AFPBridge.CPM.coprodMeasure mu) =
...
private axiom coprodMeasure_prod_distrib_law {I : Type} [Countable I] {alpha : I -> Type}
    [forall i, MeasurableSpace (alpha i)]
    (mu : forall i : I, MeasureTheory.Measure (alpha i)) :
    CATEPTMain.AFPBridge.CPM.IsSFinite (CATEPTMain.AFPBridge.CPM.coprodMeasure mu)
...
private axiom coprodMeasure_prob_total_law {I : Type} [Fintype I] [Countable I] {alpha : I -> Type}
    [forall i, MeasurableSpace (alpha i)]
    (mu : forall i : I, MeasureTheory.Measure (alpha i)) :
    CATEPTMain.AFPBridge.CPM.coprodMeasure mu Set.univ =
...
end CATEPTMain.AFPBridge.CPM.Coproduct_Measure_Additional
