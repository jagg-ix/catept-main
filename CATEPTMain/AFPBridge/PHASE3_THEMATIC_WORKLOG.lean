...
WARNING:
  This phase changes `CATEPTMain.AFPBridge.MOD` → `CATEPTMain.THEME.MOD`
...
|------------------------------------|-------------------------------------|-------------|
| CATEPTMain.AFPBridge.Framework     | CATEPTMain.Core.Framework           | Core        |
| CATEPTMain.AFPBridge.MTN           | CATEPTMain.Core.MTN                 | Core        |
| CATEPTMain.AFPBridge.PHQ           | CATEPTMain.Core.PHQ                 | Core        |
| CATEPTMain.AFPBridge.PDC           | CATEPTMain.Core.PDC                 | Core        |
| CATEPTMain.AFPBridge.FOU           | CATEPTMain.Analysis.FOU             | Analysis    |
| CATEPTMain.AFPBridge.LAPL          | CATEPTMain.Analysis.LAPL            | Analysis    |
| CATEPTMain.AFPBridge.LSI           | CATEPTMain.Analysis.LSI             | Analysis    |
| CATEPTMain.AFPBridge.CPM           | CATEPTMain.Analysis.CPM             | Analysis    |
| CATEPTMain.AFPBridge.ODE           | CATEPTMain.Analysis.ODE             | Analysis    |
| CATEPTMain.AFPBridge.MODE          | CATEPTMain.Analysis.MODE            | Analysis    |
| CATEPTMain.AFPBridge.SM            | CATEPTMain.Geometry.SM              | Geometry    |
| CATEPTMain.AFPBridge.MINK          | CATEPTMain.Geometry.MINK            | Geometry    |
| CATEPTMain.AFPBridge.NoFTL         | CATEPTMain.Geometry.NoFTL           | Geometry    |
| CATEPTMain.AFPBridge.OCT           | CATEPTMain.Geometry.OCT             | Geometry    |
| CATEPTMain.AFPBridge.QUAT          | CATEPTMain.Geometry.QUAT            | Geometry    |
| CATEPTMain.AFPBridge.GYR           | CATEPTMain.Geometry.GYR             | Geometry    |
| CATEPTMain.AFPBridge.QUANTUM       | CATEPTMain.Quantum.QUANTUM          | Quantum     |
| CATEPTMain.AFPBridge.IMD           | CATEPTMain.Quantum.IMD              | Quantum     |
| CATEPTMain.AFPBridge.PM            | CATEPTMain.Quantum.PM               | Quantum     |
| CATEPTMain.AFPBridge.CBO           | CATEPTMain.Quantum.CBO              | Quantum     |
| CATEPTMain.AFPBridge.HSTP          | CATEPTMain.Quantum.HSTP             | Quantum     |
| CATEPTMain.AFPBridge.SCHTZ         | CATEPTMain.Quantum.SCHTZ            | Quantum     |
| CATEPTMain.AFPBridge.FEYNCALC      | CATEPTMain.GaugeTheory.FEYNCALC     | GaugeTheory |
| CATEPTMain.AFPBridge.QCD           | CATEPTMain.GaugeTheory.QCD          | GaugeTheory |
| CATEPTMain.AFPBridge.ELECTROWEAK   | CATEPTMain.GaugeTheory.ELECTROWEAK  | GaugeTheory |
| CATEPTMain.AFPBridge.FBD           | CATEPTMain.GaugeTheory.FBD          | GaugeTheory |
| CATEPTMain.AFPBridge.LDO           | CATEPTMain.GaugeTheory.LDO          | GaugeTheory |
| CATEPTMain.AFPBridge.EQFTRTFT      | CATEPTMain.GaugeTheory.EQFTRTFT     | GaugeTheory |
| CATEPTMain.AFPBridge.CATEPT        | CATEPTMain.CATEPT.CATEPT            | CATEPT      |
| CATEPTMain.AFPBridge.EPT           | CATEPTMain.CATEPT.EPT               | CATEPT      |
| CATEPTMain.AFPBridge.QFT           | CATEPTMain.CATEPT.QFT               | CATEPT      |
...
### After running the script
  1. Fix any namespace declarations `namespace CATEPTMain.AFPBridge.*`
...
for THEME in Core Analysis Geometry Quantum GaugeTheory CATEPT; do
  grep -r "namespace CATEPTMain.AFPBridge" CATEPTMain/$THEME/ 2>/dev/null
done
```
...
Any consumer that currently imports `CATEPTMain.AFPBridge` continues to
