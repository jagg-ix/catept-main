import CATEPTMain.AFPBridge.NHQM.NHQMPrelude
...
namespace CATEPTMain.AFPBridge.NHQM.NHQMCATEPTBridge
...
def nhqmCATEPTSlot
    (N : ℕ) (H : CATEPTMain.AFPBridge.NHQM.NHHamiltonian N) (φ : ℝ) (ħ : ℝ) (hħ : 0 < ħ) :
    CATEPTPluginSlot where
  ConfigSpaceTy   := Fin N
  actionRe        := fun n => CATEPTMain.AFPBridge.NHQM.complexEigenvalueRe N H φ n
  actionIm        := fun n => CATEPTMain.AFPBridge.NHQM.complexEigenvalueIm N H φ n
  actionIm_nonneg := fun n => CATEPTMain.AFPBridge.NHQM.complexEigenvalueIm_nonneg N H φ n
  hbar            := ħ
  hbar_pos        := hħ
  eptClock        := fun n => CATEPTMain.AFPBridge.NHQM.complexEigenvalueIm N H φ n / ħ
  eptClock_nonneg := fun n =>
    div_nonneg (CATEPTMain.AFPBridge.NHQM.complexEigenvalueIm_nonneg N H φ n) (le_of_lt hħ)
...
theorem nhqmCATEPTSlot_eptClock_at_EP
    (N : ℕ) (H : CATEPTMain.AFPBridge.NHQM.NHHamiltonian N) (φ_EP : ℝ) (ħ : ℝ) (hħ : 0 < ħ)
    (m n : Fin N) (hEP : CATEPTMain.AFPBridge.NHQM.exceptionalPointAt N H φ_EP m n) :
...
theorem nhqmCATEPTSlot_eptClock_at_EP_strong
    (N : ℕ) (H : CATEPTMain.AFPBridge.NHQM.NHHamiltonian N) (φ_EP : ℝ) (ħ : ℝ) (hħ : 0 < ħ)
    (m n : Fin N) (hEP : CATEPTMain.AFPBridge.NHQM.exceptionalPointAtStrong N H φ_EP m n) :
    (nhqmCATEPTSlot N H φ_EP ħ hħ).eptClock m =
...
def nhqmPlugin
    (N : ℕ) (hN : 0 < N) (H : CATEPTMain.AFPBridge.NHQM.NHHamiltonian N)
  ...
  classicalTarget    := CATEPTMain.AFPBridge.NHQM.complexEigenvalueRe N H φ ⟨0, hN⟩
  quantumTarget      := CATEPTMain.AFPBridge.NHQM.complexEigenvalueRe N H φ ⟨0, hN⟩
  ...
  unifiedAction      := CATEPTMain.AFPBridge.NHQM.complexEigenvalueRe N H φ ⟨0, hN⟩
  metric             := ()
  curvature          := ()
  stressEnergy       := ()
  emField            := CATEPTMain.AFPBridge.NHQM.persistentCurrentFromSpec N H β μ φ
...
theorem nhqmPlugin_emFieldOverFlux_eq_currentField
    ...
    nhqmPlugin_emFieldOverFlux N hN H β μ ħ hħ =
      CATEPTMain.AFPBridge.NHQM.nhPersistentCurrentField N H β μ := by
  funext φ
  rfl
...
theorem nhqmPlugin_emFieldOverFlux_continuousAtEP
    ...
    (hEP : CATEPTMain.AFPBridge.NHQM.exceptionalPointAt N H φ_EP m n) :
    ContinuousAt (nhqmPlugin_emFieldOverFlux N hN H β μ ħ hħ) φ_EP := by
  simpa [nhqmPlugin_emFieldOverFlux] using
    (CATEPTMain.AFPBridge.NHQM.nhPersistentCurrentField_continuousAtEP
      N H β μ m n φ_EP hEP)

theorem nhqmPlugin_emFieldOverFlux_continuousAtEP_strong
    (N : ℕ) (hN : 0 < N) (H : CATEPTMain.AFPBridge.NHQM.NHHamiltonian N)
    (β μ : ℝ) (ħ : ℝ) (hħ : 0 < ħ) (m n : Fin N) (φ_EP : ℝ)
    (hEP : CATEPTMain.AFPBridge.NHQM.exceptionalPointAtStrong N H φ_EP m n) :
...
end CATEPTMain.AFPBridge.NHQM.NHQMCATEPTBridge
