...
Target: Lean 4 / CATEPTMain, Lean 4.29+  (namespace CATEPTMain.AFPBridge.PM)
License: BSD
...
Strategy:
  ...
  Step 3: IMD bridge: `import CATEPTMain.AFPBridge.IMD.IMDPrelude`
...
Validation:
  ...
  - `lake build CATEPTMain.AFPBridge.PM.PMPrelude` EXIT:0
-/
...
Validation:
  - `lake build CATEPTMain.AFPBridge.PM.PMPrelude` EXIT:0
  - All Theories/*.lean begin with `import CATEPTMain.AFPBridge.PM.PMPrelude`
-/
...
Checks:
  ...
  7. Full build: `lake build CATEPTMain.AFPBridge.PM` EXIT:0
