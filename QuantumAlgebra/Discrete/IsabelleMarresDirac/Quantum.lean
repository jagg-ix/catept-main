...
Status: H_is_gate proved; iter_tensor gate-preservation delegated to Definitions;
        all_zero_state proved; Deutsch_Jozsa circuit theorems scaffolded (needs_human)

Key: `kron` and `iter_tensor` defined in Definitions unblock this subset.
-/

open QuantumAlgebra.Discrete.IsabelleMarresDirac
open IMD

namespace QuantumAlgebra.Discrete.IsabelleMarresDirac.Quantum
...
end QuantumAlgebra.Discrete.IsabelleMarresDirac.Quantum
