...
def stage173Summary : String :=
  ...
  "galerkinSplitting_constants: DEF (Stage 179: lteC=E₀+ν²+1, lipC=E₀+1, both positive). " ++
  ...
  "Stage 173: +3 axioms (2 remain after Stage 179), +9 theorems (incl. private), 0 sorry. " ++
  "Stage 179: galerkinSplitting_constants promoted axiom→DEF (-1 axiom). lteC_pos+lipC_pos: linarith."
