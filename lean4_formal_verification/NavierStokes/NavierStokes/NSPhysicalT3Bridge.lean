...
theorem entropicProperTimeObs_physical_eq_agmon
    ...
    entropicProperTimeObs fourierNSObsInstance_agmon traj T := by
  unfold entropicProperTimeObs
  congr 1; congr 1; funext t
  exact physicalObs_enstrophy_fourier_id (traj.stateAt t).velocity
...
theorem palinstrophyIntegralObs_physical_eq_agmon
    ...
    palinstrophyIntegralObs fourierNSObsInstance_agmon traj T := by
  unfold palinstrophyIntegralObs
  congr 1; funext t
  exact physicalObs_palinstrophy_fourier_id (traj.stateAt t).velocity
