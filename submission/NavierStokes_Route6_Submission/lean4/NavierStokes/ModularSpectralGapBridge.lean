...
axiom ess_endpoint_criterion_exists : ESSEndpointCriterion
...
def phaseIIEpistemicStatus : List LabeledClaim :=
  ...
  , ⟨"modular_spectral_gap_existence", .openBridge,
      "Does K = -ln Δ have spectral gap c > 0 for NS von Neumann algebra?"⟩
