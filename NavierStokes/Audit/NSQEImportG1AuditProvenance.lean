...
def g1PathCAuditTargets : List String :=
  [ "NavierStokes.Fourier.NSParsevalT3Bridge"
  , "NavierStokes.Bridges.NSEnstrophyPhysicalizationBridge"
  , "NavierStokes.Galerkin.NSGalerkinCompactness"
  , "NavierStokes.Millennium.MillenniumAuditCertificate" ]
