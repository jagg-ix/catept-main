...
axiom sobolevEmbeddingConstant : Rat
axiom sobolevEmbeddingConstant_pos : 0 < sobolevEmbeddingConstant
...
axiom biotSavartNorm : Rat → Rat  -- |∇K(r)| as function of distance r

/-- Biot-Savart kernel singularity: |∇K(r)| ≤ C/r³ in 3D. -/
axiom biotSavart_singularity :
...
axiom afp_conditional_discharge_implies_vscb
